...
-- Started on 2022-12-28 22:17:36
...
ALTER SEQUENCE public.produk_no_produk_seq OWNED BY public.produk.id_produk;
...
ALTER TABLE ONLY public.produk ALTER COLUMN id_produk SET DEFAULT nextval('public.produk_no_produk_seq'::regclass);
...
COPY public.produk (id_produk, namaproduk, hargabeli, hargajual) FROM stdin;
...
-- Completed on 2022-12-28 22:17:37
